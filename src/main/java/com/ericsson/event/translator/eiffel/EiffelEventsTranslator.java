...
public class EiffelEventsTranslator {
    ...
    private String buildEiffelEventJson(CloudEvent cdevent, String cdeventType) {
        ...
        if (cdeventType.equals(Constants.CDEVENTS_ART_PUBLISHED)) {
         ...
         /*
        TODO: Different Eiffel types can be created here once the corresponding CDEvents are identified
         */
    ...
    private String buildEiffelActivityFinishedEvent(CloudEvent cdevent) {
        ...
        try {
            ...
            eiffelActivityFinishedEvent.getMsgParams().getMeta().setType(EiffelActivityFinishedEventMeta.Type.EIFFEL_ACTIVITY_FINISHED_EVENT);
            eiffelActivityFinishedEvent.getMsgParams().getMeta().setVersion(EiffelActivityFinishedEventMeta.Version._3_0_0);
            ...
            eiffelActivityFinishedEvent.getEventParams().getLinks().add(getLinkParams("ACTIVITY_EXECUTION", cdevent.getId()));
    ...
    private String buildEiffelArtifactCreatedEvent(CloudEvent inputEvent) {
        ...
        try {
            ...
            eiffelArtifactCreatedEvent.getMsgParams().getMeta().setType(EiffelArtifactCreatedEventMeta.Type.EIFFEL_ARTIFACT_CREATED_EVENT);
            eiffelArtifactCreatedEvent.getMsgParams().getMeta().setVersion(EiffelArtifactCreatedEventMeta.Version._3_0_0);
    ...
    private String buildEiffelArtifactPublishedEvent(CloudEvent inputEvent) {
        ...
        try {
            ...
            eiffelArtifactPublishedEvent.getMsgParams().getMeta().setType(EiffelArtifactPublishedEventMeta.Type.EIFFEL_ARTIFACT_PUBLISHED_EVENT);
            eiffelArtifactPublishedEvent.getMsgParams().getMeta().setVersion(EiffelArtifactPublishedEventMeta.Version._3_1_0);
